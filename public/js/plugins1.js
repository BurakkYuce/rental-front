 ...
 */ !(function (t, e) {
  if ("function" == typeof define && define.amd)
    ...
    a || (a = require("jquery")).fn || (a.fn = {}),
      (module.exports = e(require("moment"), a));
        ...
        if ("right" != t || this.endDate) {
          ...
          if (
            ...
            if (
              ...
              a.minute(
                n.find(".minuteselect option:selected").val() || a.minute()
              ),
              a.second(
                n.find(".secondselect option:selected").val() || a.second()
              ),
              !this.timePicker24Hour)
            ) {
...
!(function (t) {
  t.JQPlugin.createPlugin({
            ...
            var r =
              a < 1e12
                ? n
                  ...
                  : i()
                : a || i();
            r - o >= 1e3 && (e._updateElems(), (o = r)), s(t);
          }));
    },
    ...
    _updateCountdown: function (e, i) {
      if (((e = e.jquery ? e : t(e)), (i = i || this._getInst(e)))) {
        ...
        if (
          ...
          if (
            ((i._expiring = !0), this._hasElem(e[0]) || i.options.alwaysExpire)
          ) {
            if (
    ...
    _adjustSettings: function (e, i, n) {
      ...
      (_ = null == _ ? -s.getTimezoneOffset() : _),
        (n || (!n && null == i._until && null == i._since)) &&
          ...
          (i._until = this.UTCDate(_, this._determineTime(i.options.until, s))),
    ...
    _generateHTML: function (e) {
      ...
      for (
        ...
        (n |= "?" == e._show[r] && e._periods[r] > 0),
          (a[r] = "?" != e._show[r] || n ? e._show[r] : null),
          (s += a[r] ? 1 : 0),
          (o -= e._periods[r] > 0 ? 1 : 0);
      var l = [!1, !1, !1, !1, !1, !1, !1];
      for (r = 6; r >= 0; r--)
        e._show[r] && (e._periods[r] ? (l[r] = !0) : ((l[r] = o > 0), o--));
      var _ = e.options.compact ? e.options.compactLabels : e.options.labels,
        p = e.options.whichLabels || this._normalLabels,
        c = function (t) {
          var n = e.options["compactLabels" + p(e._periods[t])];
          return a[t]
            ? i._translateDigits(e, e._periods[t]) + (n ? n[t] : _[t]) + " "
            : "";
        },
        u = e.options.padZeroes ? 2 : 1,
        d = function (t) {
          var n = e.options["labels" + p(e._periods[t])];
    ...
    _buildLayout: function (e, i, n, s, o, a) {
      for (
        var r = e.options[s ? "compactLabels" : "labels"],
          ...
          _ = function (t) {
            return (e.options[
              (s ? "compactLabels" : "labels") + l(e._periods[t])
            ] || r)[t];
          },
          p = function (t, i) {
    ...
    _calculatePeriods: function (t, e, i, n) {
      ...
      if (e[0] || e[1]) {
        var a = this._getDaysInMonth(n.getFullYear(), n.getMonth()),
          ...
          l =
            s.getDate() == n.getDate() ||
            (s.getDate() >= Math.min(a, r) && n.getDate() >= Math.min(a, r)),
          _ = function (t) {
          ...
          p = Math.max(
            ...
            12 * (s.getFullYear() - n.getFullYear()) +
              s.getMonth() -
              n.getMonth() +
              ((s.getDate() < n.getDate() && !l) || (l && _(s) < _(n)) ? -1 : 0)
          );
        (o[0] = e[0] ? Math.floor(p / 12) : 0),
          (o[1] = e[1] ? p - 12 * o[0] : 0);
        var c = (n = new Date(n.getTime())).getDate() == a,
          u = this._getDaysInMonth(n.getFullYear() + o[0], n.getMonth() + o[1]);
        n.getDate() > u && n.setDate(u),
          n.setFullYear(n.getFullYear() + o[0]),
          n.setMonth(n.getMonth() + o[1]),
          c && n.setDate(u);
      }
      var d = Math.floor((s.getTime() - n.getTime()) / 1e3),
        h = function (t, i) {
          (o[t] = e[t] ? Math.floor(d / i) : 0), (d -= o[t] * i);
        };
      if (
        (h(2, 604800),
        h(3, 86400),
